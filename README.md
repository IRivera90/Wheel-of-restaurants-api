...
1. Rename the directory from wheel-of-restaurants-api -> your-app-name.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Move into the new project and `git init`.
1. Replace all instances of `'wheel-of-restaurants-api'` with your app name.
